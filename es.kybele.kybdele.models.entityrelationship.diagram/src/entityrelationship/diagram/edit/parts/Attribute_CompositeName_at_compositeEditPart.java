...
import entityrelationship.diagram.edit.policies.EntityRelationshipTextSelectionEditPolicy;
 ...
 * @generated
 */
public class Attribute_CompositeName_at_compositeEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				EntityRelationshipVisualIDRegistry
						.getType(entityrelationship.diagram.edit.parts.Attribute_CompositeName_at_compositeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public Attribute_CompositeName_at_compositeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new EntityRelationshipTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EntityRelationshipParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					EntityRelationshipEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new ExternalLabelCompositeAttribute();
	}

	/**
	 * @generated
	 */
	public class ExternalLabelCompositeAttribute extends WrappingLabel {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCompositeAttributeName_CompositeattributeFigure;

		/**
		 * @generated
		 */
		public ExternalLabelCompositeAttribute() {
			this.setText("composite attribute");
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureCompositeAttributeName_CompositeattributeFigure() {
			return fFigureCompositeAttributeName_CompositeattributeFigure;
		}
