...
import entityrelationship.diagram.edit.policies.RelationshipCanonicalEditPolicy;
import entityrelationship.diagram.edit.policies.RelationshipItemSemanticEditPolicy;
import entityrelationship.diagram.part.EntityRelationshipVisualIDRegistry;

/**
 * @generated
 */
public class RelationshipEditPart extends AbstractBorderedShapeEditPart {
	/**
	 * @generated
	 * 
	 */
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RelationshipName_relationshipEditPart) {
			((RelationshipName_relationshipEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRelationshipName_relationshipFigure());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof RelationshipCardinalityEditPart) {
	 ...
	 * @generated
	 */
	public class RelationshipFigure extends ScalablePolygonShape {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureRelationshipName_relationshipFigure;
		...
		public RelationshipFigure() {
			...
			this.setBorder(new MarginBorder(getMapMode().DPtoLP(13),
					getMapMode().DPtoLP(11), getMapMode().DPtoLP(11),
		...
		private void createContents() {
			...
			fFigureRelationshipName_relationshipFigure = new WrappingLabel();

			fFigureRelationshipName_relationshipFigure.setText("Relationship");

			fFigureRelationshipName_relationshipFigure
					.setAlignment(org.eclipse.draw2d.PositionConstants.CENTER);

			this.add(fFigureRelationshipName_relationshipFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRelationshipName_relationshipFigure() {
			return fFigureRelationshipName_relationshipFigure;
		}
