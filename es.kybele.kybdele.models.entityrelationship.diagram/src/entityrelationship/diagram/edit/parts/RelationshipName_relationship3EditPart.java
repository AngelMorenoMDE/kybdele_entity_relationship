 ...
 * @generated
 */
public class RelationshipName_relationship3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RelationshipName_relationship3EditPart(View view) {
		super(view);
	}
			...
			parser = EntityRelationshipParserProvider
					.getParser(
							...
							EntityRelationshipVisualIDRegistry
									.getType(entityrelationship.diagram.edit.parts.RelationshipName_relationship3EditPart.VISUAL_ID));
		}
		return parser;
	}
