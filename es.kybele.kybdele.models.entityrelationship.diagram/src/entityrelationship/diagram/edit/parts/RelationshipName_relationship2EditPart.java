 ...
 * @generated
 */
public class RelationshipName_relationship2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RelationshipName_relationship2EditPart(View view) {
		super(view);
	}
			...
			parser = EntityRelationshipParserProvider
					.getParser(
							...
							EntityRelationshipVisualIDRegistry
									.getType(entityrelationship.diagram.edit.parts.RelationshipName_relationship2EditPart.VISUAL_ID));
		}
		return parser;
	}
