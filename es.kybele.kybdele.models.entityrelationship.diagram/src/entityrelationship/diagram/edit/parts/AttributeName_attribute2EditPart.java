 ...
 * @generated
 */
public class AttributeName_attribute2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				EntityRelationshipVisualIDRegistry
						.getType(entityrelationship.diagram.edit.parts.AttributeName_attribute2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public AttributeName_attribute2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EntityRelationshipParserProvider
					.getParser(
							EntityRelationshipElementTypes.Attribute_2007,
							getParserElement(),
							EntityRelationshipVisualIDRegistry
									.getType(entityrelationship.diagram.edit.parts.AttributeName_attribute2EditPart.VISUAL_ID));
		}
