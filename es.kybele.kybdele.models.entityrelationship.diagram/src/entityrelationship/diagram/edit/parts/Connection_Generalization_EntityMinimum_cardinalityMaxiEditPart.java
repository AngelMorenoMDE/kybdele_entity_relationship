 ...
 * @generated
 */
public class Connection_Generalization_EntityMinimum_cardinalityMaxiEditPart
	...
	static {
		registerSnapBackPosition(
				EntityRelationshipVisualIDRegistry
						.getType(entityrelationship.diagram.edit.parts.Connection_Generalization_EntityMinimum_cardinalityMaxiEditPart.VISUAL_ID),
				new Point(5, 10));
	}
	 ...
	 * @generated
	 */
	public Connection_Generalization_EntityMinimum_cardinalityMaxiEditPart(
			View view) {
		super(view);
	}
