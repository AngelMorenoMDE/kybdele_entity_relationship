...
import entityrelationship.diagram.edit.policies.Attribute3CanonicalEditPolicy;
import entityrelationship.diagram.edit.policies.Attribute3ItemSemanticEditPolicy;
import entityrelationship.diagram.part.EntityRelationshipVisualIDRegistry;

/**
 * @generated
 */
public class Attribute3EditPart extends AbstractBorderedShapeEditPart {
	/**
	 * @generated
	 */
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Attribute3CanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new PrimaryAttributeFigure();
	}

	/**
	 * @generated
	 */
	public PrimaryAttributeFigure getPrimaryShape() {
		return (PrimaryAttributeFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof AttributeName_attribute3EditPart) {
	 ...
	 * @generated
	 */
	public class PrimaryAttributeFigure extends Ellipse {

		/**
		 * @generated
		 */
		public PrimaryAttributeFigure() {
			this.setLineWidth(2);
