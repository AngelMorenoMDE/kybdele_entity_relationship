 ...
 * @generated
 */
public class EntityName_entityEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	/**
	 * @generated
	 * 
	 ...
	 * @generated
	 */
	public EntityName_entityEditPart(View view) {
		super(view);
	}
			...
			parser = EntityRelationshipParserProvider
					.getParser(
							...
							EntityRelationshipVisualIDRegistry
									.getType(entityrelationship.diagram.edit.parts.EntityName_entityEditPart.VISUAL_ID));
		}
		return parser;
	}
