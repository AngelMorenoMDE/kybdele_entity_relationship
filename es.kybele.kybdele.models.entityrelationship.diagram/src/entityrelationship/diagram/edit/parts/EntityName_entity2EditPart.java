 ...
 * @generated
 */
public class EntityName_entity2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	/**
	 * @generated
	 * 
	 ...
	 * @generated
	 */
	public EntityName_entity2EditPart(View view) {
		super(view);
	}
			...
			parser = EntityRelationshipParserProvider
					.getParser(
							...
							EntityRelationshipVisualIDRegistry
									.getType(entityrelationship.diagram.edit.parts.EntityName_entity2EditPart.VISUAL_ID));
		}
		return parser;
	}
