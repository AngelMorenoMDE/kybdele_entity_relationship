 ...
 * @generated
 */
public class AttributeName_attributeEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				EntityRelationshipVisualIDRegistry
						.getType(entityrelationship.diagram.edit.parts.AttributeName_attributeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public AttributeName_attributeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EntityRelationshipParserProvider
					.getParser(
							EntityRelationshipElementTypes.Attribute_2006,
							getParserElement(),
							EntityRelationshipVisualIDRegistry
									.getType(entityrelationship.diagram.edit.parts.AttributeName_attributeEditPart.VISUAL_ID));
		}
