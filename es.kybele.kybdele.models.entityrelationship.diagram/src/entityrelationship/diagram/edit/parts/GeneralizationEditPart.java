...
import entityrelationship.diagram.edit.policies.GeneralizationCanonicalEditPolicy;
import entityrelationship.diagram.edit.policies.GeneralizationItemSemanticEditPolicy;
...
public class GeneralizationEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new GeneralizationPartialOverlappedFigure();
	}

	/**
	 * @generated
	 */
	public GeneralizationPartialOverlappedFigure getPrimaryShape() {
		return (GeneralizationPartialOverlappedFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class GeneralizationPartialOverlappedFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public GeneralizationPartialOverlappedFigure() {
			this.setURI("platform:/plugin/gmf_entity_relationship_model/svg/Generalization1.svg");
		}
