...
import entityrelationship.diagram.edit.policies.Relationship3CanonicalEditPolicy;
import entityrelationship.diagram.edit.policies.Relationship3ItemSemanticEditPolicy;
import entityrelationship.diagram.part.EntityRelationshipVisualIDRegistry;

/**
 * @generated
 */
public class Relationship3EditPart extends AbstractBorderedShapeEditPart {
	/**
	 * @generated
	 * 
	 */
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Relationship3CanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new WeakIdentificationRelationshipFigure();
	}

	/**
	 * @generated
	 */
	public WeakIdentificationRelationshipFigure getPrimaryShape() {
		return (WeakIdentificationRelationshipFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RelationshipName_relationship3EditPart) {
			((RelationshipName_relationship3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureWeakIdentificationeRelationshipName_relationshipFigure());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof RelationshipCardinality3EditPart) {
	 ...
	 * @generated
	 */
	public class WeakIdentificationRelationshipFigure extends
			ScalablePolygonShape {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureWeakIdentificationeRelationshipName_relationshipFigure;

		/**
		 * @generated
		 */
		public WeakIdentificationRelationshipFigure() {
		...
		private void createContents() {
			...
			fFigureWeakIdentificationeRelationshipName_relationshipFigure = new WrappingLabel();

			fFigureWeakIdentificationeRelationshipName_relationshipFigure
					.setText("WIdRelationship");

			fFigureWeakIdentificationeRelationshipName_relationshipFigure
					.setAlignment(org.eclipse.draw2d.PositionConstants.CENTER);

			this.add(fFigureWeakIdentificationeRelationshipName_relationshipFigure);

			WrappingLabel title20 = new WrappingLabel();

			title20.setText("Id");

			title20.setAlignment(org.eclipse.draw2d.PositionConstants.TOP);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureWeakIdentificationeRelationshipName_relationshipFigure() {
			return fFigureWeakIdentificationeRelationshipName_relationshipFigure;
		}
