...
import entityrelationship.diagram.edit.policies.AttributeCanonicalEditPolicy;
import entityrelationship.diagram.edit.policies.AttributeItemSemanticEditPolicy;
...
public class AttributeEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AttributeCanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof AttributeName_attributeEditPart) {
