 ...
 * @generated
 */
public class RelationshipName_relationshipEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RelationshipName_relationshipEditPart(View view) {
		super(view);
	}
			...
			parser = EntityRelationshipParserProvider
					.getParser(
							...
							EntityRelationshipVisualIDRegistry
									.getType(entityrelationship.diagram.edit.parts.RelationshipName_relationshipEditPart.VISUAL_ID));
		}
		return parser;
	}
