 ...
 * @generated
 */
public class Relationships_Restriction2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Relationships_Restriction2CreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateRelationships_Restriction_4008(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Relationships_Restriction newElement = EntityrelationshipFactory.eINSTANCE
				.createRelationships_Restriction();
		getContainer().getERM_Has_Rt().add(newElement);
		newElement.setSource_relationship(getSource());
		newElement.setTarget_relationship(getTarget());
		ElementInitializers.getInstance().init_Relationships_Restriction_4008(
				newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Relationships_Restriction newElement,
