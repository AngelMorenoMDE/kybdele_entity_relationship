 ...
 * @generated
 */
public class Connection_Entity2RelationshipCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public Connection_Entity2RelationshipCreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateConnection_Entity2Relationship_4020(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Connection_Entity2Relationship newElement = EntityrelationshipFactory.eINSTANCE
				.createConnection_Entity2Relationship();
		getContainer().getERM_Has_ConnectionEntity2Relationship().add(
				newElement);
		newElement.setSource_entity(getSource());
	 ...
	 * @generated
	 */
	protected void doConfigure(Connection_Entity2Relationship newElement,
