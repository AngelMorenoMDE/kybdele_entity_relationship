 ...
 * @generated
 */
public class Connection_E_R_RestrictionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Connection_E_R_RestrictionCreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateConnection_E_R_Restriction_4012(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_Connection_E_R_Restriction_4012(
				newElement);
