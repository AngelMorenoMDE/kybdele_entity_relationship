 ...
 * @generated
 */
public class Connection_Generalization_EntityCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public Connection_Generalization_EntityCreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateConnection_Generalization_Entity_4019(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Connection_Generalization_Entity newElement = EntityrelationshipFactory.eINSTANCE
				.createConnection_Generalization_Entity();
		getContainer().getERM_Has_Gen().add(newElement);
		newElement.setConnection_Generalization(getSource());
		newElement.setConnection_Entity(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(Connection_Generalization_Entity newElement,
