...
public class AttributeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Attribute newElement = EntityrelationshipFactory.eINSTANCE
				.createAttribute();

		Entity_Relationship_Model owner = (Entity_Relationship_Model) getElementToEdit();
		owner.getERM_Has_At().add(newElement);

		ElementInitializers.getInstance().init_Attribute_2006(newElement);
