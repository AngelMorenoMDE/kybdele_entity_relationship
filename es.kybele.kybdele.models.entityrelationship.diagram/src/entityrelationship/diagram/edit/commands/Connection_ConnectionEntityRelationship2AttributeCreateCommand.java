 ...
 * @generated
 */
public class Connection_ConnectionEntityRelationship2AttributeCreateCommand
	 ...
	 * @generated
	 */
	public Connection_ConnectionEntityRelationship2AttributeCreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateConnection_ConnectionEntityRelationship2Attribute_4022(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Connection_ConnectionEntityRelationship2Attribute newElement = EntityrelationshipFactory.eINSTANCE
				.createConnection_ConnectionEntityRelationship2Attribute();
		getContainer().getERM_HasConnectionEntityRelationship2Attribute().add(
				newElement);
		newElement.setSource_connection(getSource());
		newElement.setTarget_attribute(getTarget());
	...
	protected void doConfigure(
			Connection_ConnectionEntityRelationship2Attribute newElement,
