 ...
 * @generated
 */
public class Connection_With_AttributeCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Connection_With_AttributeCreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateConnection_With_Attribute_4002(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_Connection_With_Attribute_4002(
				newElement);
