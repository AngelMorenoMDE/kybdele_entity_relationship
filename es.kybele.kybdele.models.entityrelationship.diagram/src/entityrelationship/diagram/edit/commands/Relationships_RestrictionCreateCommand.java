 ...
 * @generated
 */
public class Relationships_RestrictionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Relationships_RestrictionCreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateRelationships_Restriction_4007(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_Relationships_Restriction_4007(
				newElement);
