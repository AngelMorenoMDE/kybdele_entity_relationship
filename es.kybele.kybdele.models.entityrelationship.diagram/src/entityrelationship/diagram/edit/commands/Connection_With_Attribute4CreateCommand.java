 ...
 * @generated
 */
public class Connection_With_Attribute4CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Connection_With_Attribute4CreateCommand(
	...
	public boolean canExecute() {
		...
		return EntityRelationshipBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateConnection_With_Attribute_4005(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_Connection_With_Attribute_4005(
				newElement);
