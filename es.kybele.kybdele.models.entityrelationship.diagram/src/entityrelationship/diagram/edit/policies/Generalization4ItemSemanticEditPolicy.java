 ...
 * @generated
 */
public class Generalization4ItemSemanticEditPolicy extends
		EntityRelationshipBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Generalization4ItemSemanticEditPolicy() {
		super(EntityRelationshipElementTypes.Generalization_2022);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (EntityRelationshipVisualIDRegistry.getVisualID(outgoingLink) == Connection_Generalization_EntityEditPart.VISUAL_ID) {
			...
			if (EntityRelationshipVisualIDRegistry.getVisualID(outgoingLink) == GeneralizationSuperclassEditPart.VISUAL_ID) {
