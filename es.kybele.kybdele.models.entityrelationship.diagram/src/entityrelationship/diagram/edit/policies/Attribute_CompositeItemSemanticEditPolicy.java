 ...
 * @generated
 */
public class Attribute_CompositeItemSemanticEditPolicy extends
		EntityRelationshipBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Attribute_CompositeItemSemanticEditPolicy() {
		super(EntityRelationshipElementTypes.Attribute_Composite_2013);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (EntityRelationshipVisualIDRegistry.getVisualID(incomingLink) == AttributeAttributes_compositesEditPart.VISUAL_ID) {
