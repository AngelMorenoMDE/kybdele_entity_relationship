...
import entityrelationship.diagram.providers.EntityRelationshipMarkerNavigationProvider;
import entityrelationship.diagram.providers.EntityRelationshipValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (EntityRelationshipDiagramEditorUtil.openDiagram(view
					.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		EntityRelationshipValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			EntityRelationshipMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		EntityRelationshipDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new EntityRelationshipDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = EntityRelationshipDiagramEditorUtil.findView(
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		EntityRelationshipMarkerNavigationProvider.addMarker(target, elementId,
