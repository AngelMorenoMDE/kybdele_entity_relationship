 ...
 * @generated
 */
public class EntityRelationshipInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new EntityRelationshipNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				Entity_Relationship_ModelEditPart.MODEL_ID));
		EntityRelationshipDiagramEditorUtil.runWizard(getShell(), wizard,
