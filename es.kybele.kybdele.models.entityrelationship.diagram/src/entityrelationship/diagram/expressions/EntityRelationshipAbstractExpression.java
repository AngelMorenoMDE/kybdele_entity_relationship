 ...
 * @generated
 */
public abstract class EntityRelationshipAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = EntityRelationshipDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected EntityRelationshipAbstractExpression(String body,
			EClassifier context) {
		myBody = body;
		myContext = context;
	}
