 ...
 * @generated
 */
public class EntityRelationshipViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return Entity_Relationship_ModelEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EntityRelationshipVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = EntityRelationshipVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!EntityRelationshipElementTypes
				...
				if (domainElement != null
						&& visualID != EntityRelationshipVisualIDRegistry
		...
		return EntityEditPart.VISUAL_ID == visualID
				...
				|| Relationship2EditPart.VISUAL_ID == visualID
				|| Relationship3EditPart.VISUAL_ID == visualID
				|| AttributeEditPart.VISUAL_ID == visualID
				|| Attribute2EditPart.VISUAL_ID == visualID
				|| Attribute3EditPart.VISUAL_ID == visualID
				|| Attribute_CompositeEditPart.VISUAL_ID == visualID
				|| GeneralizationEditPart.VISUAL_ID == visualID
				|| Generalization2EditPart.VISUAL_ID == visualID
				|| Generalization3EditPart.VISUAL_ID == visualID
				|| Generalization4EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op
				.getSemanticAdapter());
		if (!EntityRelationshipElementTypes.isKnownElementType(elementType)
				|| (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		...
		int visualID = EntityRelationshipVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(Entity_Relationship_ModelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case Entity2EditPart.VISUAL_ID:
			return createEntity_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case RelationshipEditPart.VISUAL_ID:
			return createRelationship_2009(domainElement, containerView, index,
					persisted, preferencesHint);
		case Relationship2EditPart.VISUAL_ID:
			return createRelationship_2010(domainElement, containerView, index,
					persisted, preferencesHint);
		case Relationship3EditPart.VISUAL_ID:
			return createRelationship_2011(domainElement, containerView, index,
					persisted, preferencesHint);
		case AttributeEditPart.VISUAL_ID:
			return createAttribute_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case Attribute2EditPart.VISUAL_ID:
			return createAttribute_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case Attribute3EditPart.VISUAL_ID:
			return createAttribute_2008(domainElement, containerView, index,
					persisted, preferencesHint);
		case Attribute_CompositeEditPart.VISUAL_ID:
			return createAttribute_Composite_2013(domainElement, containerView,
					index, persisted, preferencesHint);
		case GeneralizationEditPart.VISUAL_ID:
			return createGeneralization_2019(domainElement, containerView,
					index, persisted, preferencesHint);
		case Generalization2EditPart.VISUAL_ID:
			return createGeneralization_2020(domainElement, containerView,
					index, persisted, preferencesHint);
		case Generalization3EditPart.VISUAL_ID:
			return createGeneralization_2021(domainElement, containerView,
					index, persisted, preferencesHint);
		case Generalization4EditPart.VISUAL_ID:
			return createGeneralization_2022(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EntityRelationshipVisualIDRegistry.getVisualID(elementTypeHint)) {
		case Connection_Generalization_EntityEditPart.VISUAL_ID:
			return createConnection_Generalization_Entity_4019(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_Relationship2EntityEditPart.VISUAL_ID:
			return createConnection_Relationship2Entity_4021(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_Entity2RelationshipEditPart.VISUAL_ID:
			return createConnection_Entity2Relationship_4020(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_With_AttributeEditPart.VISUAL_ID:
			return createConnection_With_Attribute_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_With_Attribute2EditPart.VISUAL_ID:
			return createConnection_With_Attribute_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_With_Attribute3EditPart.VISUAL_ID:
			return createConnection_With_Attribute_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_With_Attribute4EditPart.VISUAL_ID:
			return createConnection_With_Attribute_4005(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_With_Attribute5EditPart.VISUAL_ID:
			return createConnection_With_Attribute_4006(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Relationships_RestrictionEditPart.VISUAL_ID:
			return createRelationships_Restriction_4007(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Relationships_Restriction2EditPart.VISUAL_ID:
			return createRelationships_Restriction_4008(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AttributeAttributes_compositesEditPart.VISUAL_ID:
			return createAttributeAttributes_composites_4009(containerView,
					index, persisted, preferencesHint);
		case Connection_E_R_RestrictionEditPart.VISUAL_ID:
			return createConnection_E_R_Restriction_4012(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case Connection_E_R_Restriction2EditPart.VISUAL_ID:
			return createConnection_E_R_Restriction_4013(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case GeneralizationSuperclassEditPart.VISUAL_ID:
			return createGeneralizationSuperclass_4017(containerView, index,
					persisted, preferencesHint);
		case Connection_ConnectionEntityRelationship2AttributeEditPart.VISUAL_ID:
			return createConnection_ConnectionEntityRelationship2Attribute_4022(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createEntity_2001(EObject domainElement, View containerView,
		...
		node.setType(EntityRelationshipVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createRelationship_2009(EObject domainElement,
		...
		Node label5013 = createLabel(node,
				EntityRelationshipVisualIDRegistry
						.getType(RelationshipCardinalityEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createRelationship_2010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label5015 = createLabel(node,
				EntityRelationshipVisualIDRegistry
						.getType(RelationshipCardinality2EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createRelationship_2011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label5017 = createLabel(node,
				EntityRelationshipVisualIDRegistry
						.getType(RelationshipCardinality3EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createAttribute_2006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createAttribute_2007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Node createAttribute_2008(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createAttribute_Composite_2013(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createGeneralization_2019(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createGeneralization_2020(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createGeneralization_2021(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createGeneralization_2022(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createConnection_Generalization_Entity_4019(
		...
		edge.setType(EntityRelationshipVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createConnection_Relationship2Entity_4021(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		location6012.setX(10);
		location6012.setY(10);
		Node label6013 = createLabel(
				edge,
				EntityRelationshipVisualIDRegistry
						.getType(Connection_Relationship2EntityMinimum_cardinalityMaxiEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createConnection_Entity2Relationship_4020(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_With_Attribute_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_With_Attribute_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_With_Attribute_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_With_Attribute_4005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_With_Attribute_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createRelationships_Restriction_4007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createRelationships_Restriction_4008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createAttributeAttributes_composites_4009(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_E_R_Restriction_4012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_E_R_Restriction_4013(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createGeneralizationSuperclass_4017(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createConnection_ConnectionEntityRelationship2Attribute_4022(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!Entity_Relationship_ModelEditPart.MODEL_ID
			...
			shortcutAnnotation.getDetails().put(
					"modelID", Entity_Relationship_ModelEditPart.MODEL_ID); //$NON-NLS-1$
