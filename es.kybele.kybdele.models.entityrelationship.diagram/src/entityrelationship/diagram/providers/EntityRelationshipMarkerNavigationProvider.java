...
import entityrelationship.diagram.part.EntityRelationshipDiagramEditorUtil;

/**
 * @generated
 */
public class EntityRelationshipMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = EntityRelationshipDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			EntityRelationshipDiagramEditorUtil.selectElementsInDiagram(editor,
