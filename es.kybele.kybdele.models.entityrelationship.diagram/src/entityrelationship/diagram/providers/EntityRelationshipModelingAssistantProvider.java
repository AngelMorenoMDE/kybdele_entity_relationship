 ...
 * @generated
 */
public class EntityRelationshipModelingAssistantProvider extends
	...
	protected EObject selectElement(EObject[] elements) {
		...
		ElementListSelectionDialog dialog = new ElementListSelectionDialog(
				shell, labelProvider);
		dialog.setMessage(Messages.EntityRelationshipModelingAssistantProviderMessage);
		dialog.setTitle(Messages.EntityRelationshipModelingAssistantProviderTitle);
