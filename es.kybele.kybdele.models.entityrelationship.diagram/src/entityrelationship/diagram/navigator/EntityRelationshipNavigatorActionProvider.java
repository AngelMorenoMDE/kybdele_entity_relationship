...
import entityrelationship.diagram.part.EntityRelationshipDiagramEditor;
 ...
 * @generated
 */
public class EntityRelationshipNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof EntityRelationshipNavigatorItem) {
					selectedElement = ((EntityRelationshipNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (Entity_Relationship_ModelEditPart.MODEL_ID
							.equals(EntityRelationshipVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, EntityRelationshipDiagramEditor.ID);
