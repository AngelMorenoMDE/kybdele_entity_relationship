 ...
 * @generated
 */
public class EntityRelationshipDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public EntityRelationshipDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof EntityRelationshipDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((EntityRelationshipDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new EntityRelationshipDomainNavigatorItem(
